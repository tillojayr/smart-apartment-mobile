...
class RoomLogin extends StatefulWidget {
  ...
  @override
  _RoomLoginState createState() => _RoomLoginState();
}

class _RoomLoginState extends State<RoomLogin> {
  final usernameController = TextEditingController();
  String apartmentId = ownerData['id'].toString();
  String apartmentName = ownerData['name'];
  ...
  Future<void> signIn() async {
    ...
    final url = Uri.parse(hostName + "api/v1/user/tenant?owner_id=$apartmentId&password=" + usernameController.text);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if(roomData['flag'] == 1){
          _showErrorMessage('Account Deactivated! This usually happens when you didnt pay rent.');
        } else{
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Please enter your room password to continue",
                                style: TextStyle(
